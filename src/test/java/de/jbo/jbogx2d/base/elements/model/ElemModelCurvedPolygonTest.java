 ...
 */
public class ElemModelCurvedPolygonTest {
    /** test-coordinate. */
    ...
    /** Model to be tested. */
    private ElemModelCurvedPolygon model = null;
    ...
    public void setUp() throws Exception {
        ...
        points[2].set(X3, Y3);
        points[3].set(X4, Y4);
        ElemCurvedPolygon polygon = new ElemCurvedPolygon(points);
        model = (ElemModelCurvedPolygon) polygon.getModel();
    }
    ...
    public void testGetShape() {
        ...
        assertTrue(model.getShape() instanceof CurvedPolygon2D);
    }
    ...
    public void testGetElement() {
        ...
        assertTrue(model.getElement() instanceof ElemCurvedPolygon);
    }
